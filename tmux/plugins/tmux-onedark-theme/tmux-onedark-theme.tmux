#!/bin/bash
onedark_black="#1f2329"        # bg0
onedark_blue="#4fa6ed"         # blue
onedark_yellow="#e2b86b"       # yellow
onedark_red="#e55561"          # red
onedark_white="#a0a8b7"        # fg
onedark_green="#8ebd6b"        # green
onedark_visual_grey="#30363f"  # bg2
onedark_comment_grey="#535965" # grey
